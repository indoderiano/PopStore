...
module.exports={
    ...
    // resources
    // https://stackoverflow.com/questions/48762165/converting-image-file-into-base64-in-express-nodejs
    // https://stackoverflow.com/questions/53463646/cannot-read-property-tostring-of-undefined-in-multer
    cloudinaryUpload:(req,res)=>{
        ...
        cloudinary.uploader.upload(`data:image/png;base64,${encoded}`, { tags: 'basic_sample' }, function (err, image) {
